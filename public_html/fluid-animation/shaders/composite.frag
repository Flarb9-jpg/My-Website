...
void main () {
    ...
    float speed = data.b;
    vec3 color = hsvToRGB(vec3(max(0.6 - speed * 0.0125, 0.52), min(1.0 - speed * 0.0125, 0.75), 1.0));
    //accented by the speed of the particle to show difference
    ...
    color *= ambient * direct * specular;
    //this is where the color of the particles change
    if (speed >= 0.0) {
